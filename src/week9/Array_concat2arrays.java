...
public class Array_concat2arrays {
    ...
    public static int[] concatenateArrays(int[] arr, int[] arr1) {
        ...
        System.arraycopy(arr, 0, result, 0, arr1.length);
        System.arraycopy(arr1, 0, result, arr1.length, arr1.length);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(result)); // Output: [1, 2, 3, 4, 5, 6,7,8]
    }
}
